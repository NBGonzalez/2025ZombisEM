        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < cols; j++)
            {
                ...
                if (i % 2 == 0 && j % 2 == 0)
                {
                    ...
                    humanSpawnPoints.Add(spawnPoint + new Vector3(spawnPoint.x * 2, 0, 0)); // Abajo - Derecha
                    humanSpawnPoints.Add(spawnPoint + new Vector3(0, 0, spawnPoint.z * 2)); // Arriba - Izquierda
                    humanSpawnPoints.Add(spawnPoint + new Vector3(spawnPoint.x * 2, 0, spawnPoint.z * 2)); // Arriba - Derecha
                    zombieSpawnPoints = humanSpawnPoints;
                }
                else
                {
